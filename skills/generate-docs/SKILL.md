...
>
> **Now start a fresh Codex session.** Generating the full doc set in this conversation would cause context rot — the model loses precision as the session grows. In the new session, invoke the `start` skill with the task:
>
